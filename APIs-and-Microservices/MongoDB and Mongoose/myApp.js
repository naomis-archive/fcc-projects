...
var createAndSavePerson = function(done) {
  let JordanStevenson = new Person({"name":"Jordan Stevenson", "age": 49, "favoriteFoods":["apples", "sushi"]})
  JordanStevenson.save(function(err, data){
...
// 'arrayOfPeople'.
var arrayOfPeople = [{"name": "Jack Black", "age": 43, "favoriteFoods":["cats", "dogs"]}, {"name":"John Smith", "age":12,"favoriteFoods":["pasta", "cheese", "cronch"]}]
var createManyPeople = function(arrayOfPeople, done) {
let manyPeople = Person.create(arrayOfPeople, function(err, data){
    done(null, data);})
...
var findEditThenSave = function(personId, done) {
  ...
  let personById = Person.findById(personId, function(err, data) {
    if(err) {return console.log(err)}
...
var removeById = function(personId, done) {
  ...
  {_id: personId}, function(err, data){
    if(err) {return console.log(err)}
    done(null, data)
  })    
};
